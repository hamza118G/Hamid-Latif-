  ...
  return (
    <Container className="my-5">
      <Card className="vibrant-card">
        <Card.Body>
          <Card.Title className="text-center mb-4">Add New Patient Record</Card.Title>
              ...
              <Row key={index} className="mb-3">
                <Col md={4}>
                  <Form.Group>
                    ...
                    <Form.Select value={cycle.cycle} onChange={(e) => handleCycleChange(index, 'cycle', e.target.value)}>
                      ...
                      <option value="Cycle 02: Carboplatin + Paclitaxel + Atezolizumab">Cycle 02: Carboplatin + Paclitaxel </option>
                ...
                <Col md={4}>
                  <Form.Group>
                    ...
                    <Form.Control type="date" value={cycle.date} onChange={(e) => handleCycleChange(index, 'date', e.target.value)} />
                  </Form.Group>
                </Col>
                <Col md={4}>
                  <Form.Group>
